...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
        ...
        var centralRegion = ObjectSpace.FindObject<Region>(new BinaryOperator("Name", "Central"));
        if(centralRegion == null ) 
        {
            centralRegion = ObjectSpace.CreateObject<Region>();
            centralRegion.Name = "Central";
            ObjectSpace.CommitChanges();
        }
        var southRegion = ObjectSpace.FindObject<Region>(new BinaryOperator("Name", "South"));
        if (southRegion == null)
        {
            southRegion = ObjectSpace.CreateObject<Region>();
            southRegion.Name = "South";
            ObjectSpace.CommitChanges();
        }
        var eastRegion = ObjectSpace.FindObject<Region>(new BinaryOperator("Name", "East"));
        if (eastRegion == null)
        {
            eastRegion = ObjectSpace.CreateObject<Region>();
            eastRegion.Name = "East";
            ObjectSpace.CommitChanges();
        }
        var westRegion = ObjectSpace.FindObject<Region>(new BinaryOperator("Name", "West"));
        if (westRegion == null)
        {
            westRegion = ObjectSpace.CreateObject<Region>();
            westRegion.Name = "West";
            ObjectSpace.CommitChanges();
        }
        var northRegion = ObjectSpace.FindObject<Region>(new BinaryOperator("Name", "North"));
        if (northRegion == null)
        {
            northRegion = ObjectSpace.CreateObject<Region>();
            northRegion.Name = "North";
            ObjectSpace.CommitChanges();
        }
